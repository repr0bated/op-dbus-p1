...
echo "🎯 Next steps:"
echo "1. Start your MCP servers:"
echo "   ./start-chat-server.sh"
echo ""
echo "2. Start the agents server:"
echo "   cargo run --bin op-agents-server"
echo ""
echo "3. Open Google Antigravity IDE"
echo ""
echo "4. Use any of the 80+ specialized agents!"
echo ""
echo "5. Example commands in Antigravity:"
