...
pub struct IntrospectiveGadget {
    knowledge_base: std::sync::Arc<tokio::sync::RwLock<crate::native_introspection::KnowledgeBase>>,
...
impl IntrospectiveGadget {
    ...
    pub async fn new(knowledge_base: std::sync::Arc<tokio::sync::RwLock<crate::native_introspection::KnowledgeBase>>) -> Result<Self> {
    ...
    async fn generate_knowledge_base_entry(&self, result: &ParsedObject, input: &InspectionInput) -> Result<crate::native_introspection::SchemaDefinition> {
        ...
        Ok(crate::native_introspection::SchemaDefinition {
            name,
            source_type,
